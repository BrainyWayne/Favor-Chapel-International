...
class _UploadEventState extends State<UploadEvent> {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
          ...
          appBar: GradientAppBar(
            ...
            title: Text('Upload Event', style: TextStyle(fontSize: 18),),
                                      ...
                                      onPressed: () {
                                        DatePicker.showDatePicker(context,
                                            ...
                                            maxTime: DateTime(2025, 6, 7), onChanged: (date) {
                                              ...
                                              setState(() {
                                                var StartDate = startDate.toString().split(" ");
                                                startDateController.text = StartDate[0];
                                              });
                                      ...
                                      onPressed: () {
                                        DatePicker.showDatePicker(context,
                                            ...
                                            maxTime: DateTime(2025, 6, 7), onChanged: (date) {
                                              ...
                                              print('confirm $date');
                                              setState(() {
                                                var EndDate = date.toString().split(" ");
                              ...
                              Container(
                                ...
                                child: InkWell(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(
                                      'Upload Event',style: TextStyle(color: Colors.blue, fontSize: 22, fontWeight: FontWeight.bold),
                                    ),
                                  ),
                                ),
                              )
  ...
  Future<String> photoOption() async {
    try {
      ...
      FirebaseStorage.instance.ref().child("images").child(DateTime.now().millisecondsSinceEpoch.toString());
